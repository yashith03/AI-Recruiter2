          ...
          <main className="flex flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
            <div className="w-full max-w-md space-y-8">
              <div className="overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-slate-900/5">
                <div className="h-64 w-full bg-gradient-to-br from-blue-50 to-indigo-50 animate-pulse"></div>
                <div className="px-8 py-12 space-y-4">
                  <div className="h-8 bg-slate-200 rounded animate-pulse"></div>
                  <div className="h-4 bg-slate-200 rounded animate-pulse w-3/4 mx-auto"></div>
                  <div className="h-10 bg-slate-200 rounded-lg animate-pulse mt-8"></div>
                </div>
              </div>
            </div>
          </main>
    ...
    <div className="bg-background-light font-display text-slate-900 antialiased">
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
          <div className="w-full max-w-md space-y-8">
            <div className="overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-slate-900/5">
              <div className="relative h-64 w-full bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center overflow-hidden">
